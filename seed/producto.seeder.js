  ...
  try {
    ...
    const productos = [
      // --- ENTRADAS ---
      {
        ...
        descripcion:
          "Empanadas cortadas a cuchillo, jugosas, con cebolla de verdeo y huevo. Porción de 2 unidades.",
        precio: 2500,
        categoria: "entrada",
        imagen:
          "https://images.unsplash.com/photo-1616035133202-d96205779c11?auto=format&fit=crop&w=800&q=80",
      },
      {
        _id: new mongoose.Types.ObjectId(),
        nombre: "Provoleta Clásica",
        descripcion:
          "Queso provolone fundido a la parrilla con orégano y aceite de oliva. Sale con pan casero.",
        precio: 4200,
        categoria: "entrada",
        imagen:
          "https://images.unsplash.com/photo-1628113400539-75618b7636e7?auto=format&fit=crop&w=800&q=80",
      },
      ...
      // --- PRINCIPALES ---
      {
        ...
        descripcion:
          "Doble medallón de carne (360g), cuádruple cheddar, bacon crocante y salsa mil islas.",
        precio: 6500,
        categoria: "principal",
        imagen:
      ...
      },
      {
        ...
        descripcion:
          "Milanesa de ternera XL con dos huevos fritos arriba. Acompañada de papas fritas.",
        precio: 7800,
        categoria: "principal",
        imagen:
      ...
      },
      {
        ...
        descripcion:
          "Masa madre, salsa de tomate casera, abundante muzzarella y aceitunas verdes.",
        precio: 5500,
        categoria: "principal",
        imagen:
      ...
      // --- BEBIDAS ---
      {
        ...
        descripcion:
          "Pinta 500ml. Cerveza rubia con amargor intenso y notas cítricas.",
        precio: 2800,
        categoria: "bebida",
        imagen:
      ...
      },
      {
        ...
        descripcion:
          "Jarra de 1 litro. Exprimido natural con menta fresca y jengibre.",
        precio: 3200,
        categoria: "bebida",
        imagen:
      ...
      // --- POSTRES (NUEVO) ---
      {
        ...
        descripcion:
          "Flan de huevo tradicional con abundante dulce de leche y crema chantilly.",
        precio: 2900,
        categoria: "postre",
        imagen:
          "https://images.unsplash.com/photo-1551024601-569d6f46319c?auto=format&fit=crop&w=800&q=80",
      },
      {
        _id: new mongoose.Types.ObjectId(),
        nombre: "Volcán de Chocolate",
        descripcion:
          "Soufflé de chocolate caliente con corazón líquido, acompañado de una bocha de helado de americana.",
        precio: 3800,
        categoria: "postre",
        imagen:
